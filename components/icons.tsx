...
export const PackageIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M19 13.6a8.9 8.9 0 0 1-14 0" />
    <path d="m8 21 1.7-1.7" />
    <path d="m14.3 19.3 1.7 1.7" />
    <path d="M12 13a7.3 7.3 0 0 0-4.3 1.3" />
    <path d="M12 13h0" />
    <path d="M16.3 14.3A7.3 7.3 0 0 0 12 13" />
  </svg>
);
...
export const BarcodeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M3 5v14"></path><path d="M8 5v14"></path><path d="M12 5v14"></path><path d="M17 5v14"></path><path d="M21 5v14"></path></svg>
);
...
export const WhatsappIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M16.75 13.96c.25.13.42.3.52.49.1.19.1.42.06.68-.04.26-.16.51-.34.75-.18.24-.41.45-.69.63-.28.18-.6.33-1.02.46-.42.13-.88.2-1.4.2-.52 0-1.04-.07-1.57-.21-.53-.14-1.06-.36-1.59-.65-.53-.29-.99-.64-1.39-1.04-.4-.4-.72-.8-1-1.2-.28-.4-.49-.8-.63-1.2s-.21-.8-.21-1.2c0-.51.07-1.02.21-1.52.14-.5.35-.98.63-1.43.28-.45.63-.86 1.04-1.22.41-.36.88-.66 1.4-.89.52-.23 1.08-.34 1.68-.34.52 0 1.01.06 1.47.19.46.13.88.32 1.26.58.38.26.7.58.96.96.26.38.46.8.58 1.26.13.46.19.95.19 1.47 0 .52-.06 1.01-.19 1.47-.13.46-.32.88-.58 1.26-.26.38-.58.7-.96.96-.38.26-.8.46-1.26.58zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/>
    </svg>
);
